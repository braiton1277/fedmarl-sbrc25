...
O sistema implementa seleção de clientes em aprendizado federado usando Value Decomposition Networks (VDN), com foco em robustez a ataques bizantinos (label flipping) em cenários de dados não-IID.
...
> **Nota sobre tempo de execução:** 500 rodadas com 50 clientes e `local_steps=10` levam aproximadamente 1 hora em GPU. Um resultado pré-computado de referência (`results_random_vs_vdn_targeted_PROJMOM_FO_seed2049_92768206f1.json`) está disponível no repositório para consulta imediata.
